    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                @forelse ($topups_transaction as $transaction)
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{number_format($transaction->amount, 0, ",", ".")}}</h3>
                    </div>
                    <div>
                ...
                @empty
                    <p>Belum ada transaksi top up terbaru</p>
                @endforelse
